...
const Home = () => {
  ...
  return (
    <div>
      <Box mb={5}>
        <Heading fontSize={6} mb={3} css={{ maxWidth: "30em" }}>
          Backup your secrets using your social circle
        </Heading>
        <Text lineHeight={1.4} fontSize={4} mb={3} css={{ maxWidth: "30em" }}>
          fragment.sh is a tool that allows you to split up a secret into
          multiple fragments that can shared with friends and family. When you
          need the secret you can ask for the fragments and combine them
